...
\begin{document}
    ...
    Alles wie erwartet.
    48 Fragen, bei 38 korrekt eine 4.
...
\section{Generelle Anmerkungen}
    \begin{itemize}
        ...
        \item Die Anzahl Fragen kam mir als grösser als 20 vor.
    ...
    Allfällige öffentliche Publikationen erfolgen ohne das Einverständnis des Autors.
\end{document}