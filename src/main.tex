...
\title{Gedächtnissprotokoll Jagdprüfung}
\author{Tobias Famos}
...
\begin{document}
    ...
    \begin{enumerate}
        \item Welcher is marderartig? (Dachs, Eichhörnchen, Waschbär, Fuchs)
        \item Vogel erkennen ca 6 Fotos quer über alle Ordnungen. Nur art nennen
        \item Bild von Hirsch: Welches Tier sehen sie hier und ansprechen
        \item Bild von Goldschakal: Welches Tier sehen Sie hier?
        \item Zwei Krickern einer Gams bekomen: Welches Tier? Wie Alt? Welches Geschelcht?
    ...
    \begin{enumerate}
        ...
        \item Balz vom Auerwild
        \item Lebensraum vom Auerwild
    \end{enumerate}
